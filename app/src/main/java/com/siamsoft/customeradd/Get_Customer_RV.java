...
public class Get_Customer_RV extends AppCompatActivity {
    ...
    final private String JSONURL = "http://10.0.2.2/LMEM_01/getallCustomer.php";
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        Model proo = new Model(modelObject.getInt("c_id"), modelObject.getString("c_fullname"), modelObject.getString("c_mobile"));
